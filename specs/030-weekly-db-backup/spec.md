...
- **Dump vazio ou anormalmente pequeno** (ex: dump de banco errado ou vazio): piso de tamanho mínimo (100 KB no artefato comprimido) reprova antes mesmo da verificação de restauração.

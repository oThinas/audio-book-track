...
export function EditorsTable({
  ...
  return (
    <ScrollArea data-testid="editors-scroll-area" className="max-h-[70vh] w-full rounded-lg border">
          ...
          {sortedRows.length === 0 && !topRow && (
            <TableRow>
              <TableCell colSpan={columns.length} className="p-0">
                <div
                  data-testid="editors-empty-state"
                  className="flex flex-col items-center justify-center py-16 text-center"
                >
                  <p className="text-sm font-medium text-foreground">Nenhum editor cadastrado</p>
                  <p className="mt-1 text-sm text-muted-foreground">
                    Clique em &quot;+ Novo Editor&quot; para adicionar o primeiro.
                  </p>
                </div>
              </TableCell>
            </TableRow>
